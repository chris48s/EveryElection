...
from elections.tests.factories import create_election_with_status
...
class TestElectionAPIQueries(APITestCase):
    ...
    def test_election_endpoint(self):
        id = create_election_with_status(group=None).election_id
    ...
    def test_election_endpoint_current(self):
        id_current = create_election_with_status(
            group=None, poll_open_date=datetime.today()).election_id
        id_future = create_election_with_status(  # noqa
            group=None,
    ...
    def test_election_endpoint_for_postcode(self):
        ...
        create_election_with_status(group=None, election_id=election_id)
        create_election_with_status(group=None, division_geography=None)
    ...
    def test_metadata_filter(self):
        election = create_election_with_status(group=None, poll_open_date=datetime.today())
        resp = self.client.get(
    ...
    def test_deleted_filter_list(self):
        approved = create_election_with_status(group=None, moderation_status='Approved')
        deleted = create_election_with_status(group=None, moderation_status='Deleted')
    ...
    def test_deleted_filter_detail(self):
        election = create_election_with_status(group=None, moderation_status='Deleted')
    ...
    def test_all_expected_fields_returned(self):
        ...
        create_election_with_status(group=None, organisation=org, division=org_div)
